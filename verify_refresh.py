...
Usage:
  python verify_refresh.py snapshot DB SNAPSHOT.json   # before the refresh
  python verify_refresh.py compare  DB SNAPSHOT.json   # after the refresh
"""
...
from jeopardy_consts import JEOPARDY_NOTETYPE_ID, TOTAL_FIELDS
