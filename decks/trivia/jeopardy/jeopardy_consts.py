...
# Data files live beside this module, so no script depends on the current directory.
JEOPARDY_DIR: Final[Path] = Path(__file__).resolve().parent
DATA_DIR: Final[Path] = JEOPARDY_DIR / "data"
...
TAXONOMY_PATH_DEFAULT: Final[str] = str(DATA_DIR / "category_taxonomy.json")
